<?
  ...
  $this->DB->q("DELETE FROM projekty_punkty_glosowania WHERE `punkt_id`='$punkt_id'");
  $this->DB->q("DELETE FROM punkty_glosowania_druki WHERE `punkt_id`='$punkt_id'");
  $this->DB->q("UPDATE punkty_glosowania SET `akcept`='0' WHERE `id`='$punkt_id'");
