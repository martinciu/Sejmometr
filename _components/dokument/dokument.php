<?
  function sf_dokument($params){
    ...
    switch( $_mode ) {
      case 'scribd': {
        $result = '<a doc_id="'.$params['scribd_doc_id'].'" doc_key="'.$params['scribd_access_key'].'" title="'.$params['title'].'" class="dokument reader '.$size.'" href="#" onclick="return false;"><img class="d" src="/d/'.$_size.'/'.$params['dokument_id'].'.gif" /><p class="overlay_bg">&nbsp;</p><div class="overlay"><img class="lupa" src="/g/p.gif" /><p class="str">'.$params['ilosc_stron'].' str</p></div></a>';
        break;
      }
      case 'file': {
