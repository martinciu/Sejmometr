<?
  ...
  $item = $this->DB->selectAssoc("SELECT wypowiedzi.id, wypowiedzi.autor_id, wypowiedzi.funkcja_id, wypowiedzi_funkcje.nazwa as 'funkcja_label', wypowiedzi.skrot, ludzie.nazwa, ludzie.avatar, wypowiedzi.text, posiedzenia_dni.data, wypowiedzi.punkt_id, punkty_wypowiedzi.sejm_id as 'punkt_tytul' FROM wypowiedzi LEFT JOIN ludzie ON wypowiedzi.autor_id=ludzie.id LEFT JOIN wypowiedzi_funkcje ON wypowiedzi.funkcja_id=wypowiedzi_funkcje.id LEFT JOIN posiedzenia_dni ON wypowiedzi.dzien_id=posiedzenia_dni.id LEFT JOIN punkty_wypowiedzi ON wypowiedzi.punkt_id=punkty_wypowiedzi.id WHERE wypowiedzi.id='$id'");
